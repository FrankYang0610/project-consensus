...
export const sampleTeachers: Teacher[] = [
  {
    ...
    bio: 'Focus on social sciences and interdisciplinary research. Passionate about student mentorship and applied social research.',
  ...
  },
  {
    ...
    bio: 'Specializes in quantitative social research. Courses emphasize methodology and critical thinking.',
    homepageUrl: 'https://www.polyu.edu.hk/apss/',
...
export function getCoursesByTeacherId(id: string): TeacherCourseRef[] {
  ...
  return sampleCourses
    ...
    .map<TeacherCourseRef>(c => ({ subjectId: c.subjectId, subjectCode: c.subjectCode, title: c.title }));
}
