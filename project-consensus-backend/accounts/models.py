...
class Profile(models.Model):
    ...
    # Nickname change cooldown in days
    ...
    def days_until_nickname_update_allowed(self) -> int | None:
        ...
        Business rule:
        - Nickname can be updated at most once every NICKNAME_COOLDOWN_DAYS days.
        ...
        if days_since_update >= self.NICKNAME_COOLDOWN_DAYS:
            return None
        return self.NICKNAME_COOLDOWN_DAYS - days_since_update
