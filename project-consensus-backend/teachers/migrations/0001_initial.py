...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='teacher',
            index=GistIndex(fields=['name'], name='teacher_name_trgm_idx', opclasses=['gist_trgm_ops']),
        ),
        migrations.AddIndex(
            model_name='teacher',
            index=GistIndex(fields=['department'], name='teacher_department_trgm_idx', opclasses=['gist_trgm_ops']),
        ),
        migrations.AddIndex(
            model_name='teacher',
            index=GistIndex(fields=['bio'], name='teacher_bio_trgm_idx', opclasses=['gist_trgm_ops']),
        ),
        migrations.AddIndex(
            model_name='teacher',
