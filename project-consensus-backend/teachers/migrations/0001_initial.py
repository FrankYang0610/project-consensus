    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_difficulty', models.FloatField(blank=True, null=True)),
                ('rating_friendliness', models.FloatField(blank=True, null=True)),
                ('rating_clarity', models.FloatField(blank=True, null=True)),
            ...
            options={
                ...
                'indexes': [
                    models.Index(fields=['name'], name='teachers_te_name_idx'),
                    models.Index(fields=['department'], name='teachers_te_dept_idx'),
                ],
            },
        ),
    ]
